...
import com.eternalnovices.cotasker.service.bussineslogic.concrete.usuario.RegistrarUsuarioUseCase;
import com.eternalnovices.cotasker.service.bussineslogic.validator.concrete.usuario.RegistrarUsuarioValidator;
...
public class RegistrarUsuarioFacade implements Facade<UsuarioDTO>{
	...
	public void execute(final UsuarioDTO dto) {
		...
		try {
			...
			daofactory.cancelarTransaccion();
			final var mensajeUsuario = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000000835);
			final var mensajeTecnico = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000000836);
