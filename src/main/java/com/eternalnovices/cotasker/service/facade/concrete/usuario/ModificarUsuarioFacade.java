...
public final class ModificarUsuarioFacade implements Facade<UsuarioDTO>{
	...
	public void execute(final UsuarioDTO dto) {
		...
		try {
			...
			daofactory.cancelarTransaccion();
			final var mensajeUsuario = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000000325);
			final var mensajeTecnico = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000000326);
