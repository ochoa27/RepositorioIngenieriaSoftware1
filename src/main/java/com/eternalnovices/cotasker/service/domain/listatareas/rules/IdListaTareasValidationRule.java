...
public class IdListaTareasValidationRule implements ValidationRule<UUID> {
	private static final ValidationRule<UUID> instancia = new IdListaTareasValidationRule();
	
	private IdListaTareasValidationRule () {
		super();
	}
