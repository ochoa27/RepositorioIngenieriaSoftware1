...
public class FechasEntity {
	...
	private FechasEntity(final Date fechaCreacion, final Date fechaEstimadaInicio, final Date fechaEstimadaFin) {
		setFechaCreacion(fechaCreacion);
		setFechaEstimadaInicio(fechaEstimadaInicio);
		setFechaEstimadaFin(fechaEstimadaFin);
	}
	
	public static final FechasEntity crear(final Date fechaCreacion, final Date fechaEstimadaInicio, final Date fechaEstimadaFin) {
		return new FechasEntity(fechaCreacion, fechaEstimadaInicio, fechaEstimadaFin);
	}
